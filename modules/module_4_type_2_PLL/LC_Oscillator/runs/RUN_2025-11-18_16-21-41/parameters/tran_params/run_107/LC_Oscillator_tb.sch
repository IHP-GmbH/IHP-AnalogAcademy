...
N 1720 -1060 1720 -1030 {lab=Kvd}
N 1720 -970 1720 -940 {lab=GND}
N 1350 -940 1370 -940 {lab=Kvd}
...
set wr_singlescale
wrdata /home/pedersen/projects/IHP-AnalogAcademy/modules/module_4_type_2_PLL/LC_Oscillator/runs/RUN_2025-11-18_16-21-41/parameters/tran_params/run_107/LC_Oscillator_tb_107.data vo_diff
quit

.endc
"}
C {vsource.sym} 1570 -1000 0 0 {name=V1 value=1.6 savecurrent=false}
...
C {vsource.sym} 1720 -1000 0 0 {name=V2 value=0.8 savecurrent=false}
C {gnd.sym} 1720 -940 0 0 {name=l1 lab=GND}
C {lab_pin.sym} 1720 -1060 0 0 {name=p3 sig_type=std_logic lab=Kvd}
C {ipin.sym} 1370 -940 2 0 {name=p4 lab=Kvd}
